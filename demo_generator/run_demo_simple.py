...
def demo_parse_arguments(database):
    ...
    args = parser.parse_args(["--task",database,"--pred_file",f"log/{database}_zero_shot_cot.log","--demo_save_dir",f"demos/{database}"])
    return args

def create_demo(database):
    args = demo_parse_arguments(database)
